        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' + '   <div class="Card-picture">' + '<a href="/books/' + book.slug + '">' + '       <img src="' + book.image + '">\n' + '</a>' +
                    ...
                    '    </div>' + '              <div class="Card-content">\n' + '                <strong class="Card-title"><a href="#">' + book.title +
                    '</a>\n' + '                </strong>\n' + '                <div class="Card-description">' + book.authors + '                </div>\n' +
                    '                <div class="Card-cost">' + (book.price ? '<span class="Card-priceOld">₽' + book.price + '</span>\n' : '') +
            ...
            return {
                init: function () {
                    ...
                    $btnSend.on('click', function (e) {
                        ...
                        if ($this.data('sendstatus') === 'KEPT' && $this.data('bookid')) {
                            console.log('KEPT ОТРАБОТАЛ')
                            Login().postData('/books/changeBookStatusKept/' + $this.data('bookid'), {
                                booksIds: $this.data('bookid'),
                                status: status
                            }, function (result) {
                                if ($this.is('[data-btntype="check"]')) {
                        ...
                        if($this.data('sendstatus') === 'UNLINKPOSTPONED'){
                            Login().postData('/books/changeBookStatusKept/' + $this.data('bookid'), {
                                booksIds: $this.data('bookid'),
                                status: status
                            }, function (result) {
                                if (result.result) {
                                    ...
                                    if ($cart.length) {
                                        ...
                                        if ($this.hasClass('Cart-buyAll')) {
                                            window.location.href = '/postponed.html';
                                        }
                                    }
                                    if ($this.is('[data-btntype="check"]')) {
                                        shiftCheck($this);
                        ...
                        else if($this.data('sendstatus') === 'CART' && $this.data('bookid')) {
