...
// Удаление закомментировано, т.к. мы загружаем данные скриптом data.sql
//        deleteTestEntityById(4L);

        Logger.getLogger(CommandLineRunnerImpl.class.getSimpleName()).info(bookRepository.findBooksByAuthor_FirstName("Constantine").toString());
